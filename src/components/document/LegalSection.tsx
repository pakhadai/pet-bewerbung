    ...
    switch (variant) {
      case 'classic':
        return {
          ...
          fieldLabel:
            'block text-[9px] text-slate-600 uppercase tracking-wide mb-0.5 font-semibold',
          fieldValue:
            'font-mono bg-white px-1.5 py-0.5 border border-slate-200 text-[10px] inline-block',
      ...
      case 'modern':
        return {
          ...
          grid: 'grid grid-cols-2 gap-y-1.5 gap-x-3',
          fieldLabel:
            'block text-[9px] text-teal-900/65 uppercase tracking-wide mb-0.5 font-semibold',
          fieldValue:
            'font-mono bg-white px-1.5 py-0.5 border border-teal-200 rounded text-[10px] inline-block',
          fieldValueText: 'font-medium text-[11px]',
      ...
      case 'swiss':
        return {
          ...
          fieldLabel:
            'block text-[9px] text-slate-600 uppercase tracking-wide mb-0.5 font-semibold',
          fieldValue:
            'font-mono bg-white px-1.5 py-0.5 border border-gray-300 text-[10px] inline-block',
          fieldValueText: 'font-medium text-[11px]',
      ...
      case 'buddy':
        return {
          ...
          fieldLabel:
            'block text-[9px] text-[#3f4947] uppercase tracking-wide mb-0.5 font-semibold',
          fieldValue:
            'font-mono bg-white px-1.5 py-0.5 border border-[#bec9c7] text-[10px] inline-block text-[#0b1c30]',
      ...
      case 'buddyTest':
        return {
          container:
            'bg-gradient-to-br from-[#e0f2fe] to-[#fffbeb] p-4 border-2 border-amber-200/60 rounded-2xl shadow-sm',
          heading:
            'text-[#0f3d3a] font-extrabold text-base mb-3 pb-2 border-b-2 border-amber-400/40',
          grid: 'grid grid-cols-2 gap-y-2 gap-x-4',
          fieldLabel: 'block text-[9px] text-[#92400e] uppercase tracking-wide mb-0.5 font-bold',
          fieldValue:
            'font-mono bg-white px-1.5 py-0.5 border border-amber-200 text-[10px] inline-block text-[#0b1c30]',
          fieldValueText: 'font-medium text-[11px] text-[#0b1c30]',
      ...
      default:
        return {
          ...
          fieldLabel:
            'block text-[8px] text-stone-600 uppercase tracking-wider mb-0.5 font-semibold',
          fieldValue:
            'font-mono bg-stone-50 px-1 py-0.5 border border-stone-300 text-[9px] inline-block',
          fieldValueText: 'font-medium text-[10px]',
          statusContainer:
            'col-span-2 flex flex-wrap gap-2 mt-1.5 pt-1.5 border-t border-dashed border-stone-400',
        }
    }
  }
