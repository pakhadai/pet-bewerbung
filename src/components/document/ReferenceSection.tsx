...
import { getReferenceSectionTokens } from '../../templates/htmlVariantTokens'
...
const ReferenceSection: React.FC<ReferenceSectionProps> = ({ data, t, variant = 'classic' }) => {
  ...
  const styles = getReferenceSectionTokens(variant)
  ...
  return (
    <div className={styles.container}>
      ...
      {data.secondaryEmergencyContact && (
        <div
          className={`${styles.secondaryContact.container} border-t ${styles.secondaryContact.border}`}
        >
          <span className={styles.fieldLabel}>
