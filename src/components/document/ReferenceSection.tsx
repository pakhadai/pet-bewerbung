...
const ReferenceSection: React.FC<ReferenceSectionProps> = ({ data, t, variant = 'classic' }) => {
  ...
  const getVariantStyles = (): VariantStyles => {
    ...
    const modern = {
      ...
      heading: 'font-bold text-[11px] mb-2 pl-2 border-l-4 border-teal-500 text-teal-950 pb-1.5 border-b border-teal-200/60',
    ...
    <div className={styles.container}>
      ...
      {data.secondaryEmergencyContact && (
        <div className="mt-2 pt-1.5 border-t border-blue-200 text-[9px] text-slate-600">
          <span className={styles.fieldLabel}>{labels?.secondaryEmergencyContact ?? step2Emergency?.secondaryContact ?? 'Zweiter Kontakt'}: </span>
