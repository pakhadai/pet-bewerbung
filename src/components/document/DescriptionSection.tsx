    ...
    switch (variant) {
      case 'classic':
        return {
          container: '',
          heading:
            'font-bold uppercase tracking-wider text-xs mb-3 pb-2 border-b-2 border-slate-900',
      ...
      case 'modern':
        return {
          container: '',
          heading: 'font-bold text-base mb-3 pl-3 border-l-4 border-teal-500 text-slate-900',
          text: 'text-sm leading-relaxed text-slate-700 text-left',
        }
      ...
      case 'buddy':
        return {
          container: '',
          heading: 'text-xl font-bold text-[#004541] mb-3 flex items-center gap-2',
