...
export const getModernConfig = (today: string): TemplateConfig => ({
  container:
    'w-[210mm] h-[292mm] bg-gradient-to-br from-teal-50/40 via-white to-slate-50 text-slate-900 p-[12mm] text-xs font-sans relative box-border flex flex-col shadow-none mx-auto overflow-hidden',
  headerContainer: 'mb-4 pb-3 border-b-2 border-teal-500/35',
  headerFlex: 'flex items-start justify-between',
  headerIconContainer: 'flex items-center gap-3',
  headerIconBg: 'bg-white p-2 rounded-xl border border-teal-200 shadow-sm',
  headerIconSize: 18,
  titleText: 'text-2xl font-bold text-slate-900 tracking-tight',
  subtitleText: 'text-[11px] text-teal-800/90 mt-1.5 font-medium',
  dateText: 'text-[10px] text-teal-700/70 text-right',
  dateLabel: today,
