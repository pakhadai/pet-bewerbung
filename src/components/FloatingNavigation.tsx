...
const FloatingNavigation = React.memo<FloatingNavigationProps>(
  ({ step, onPrev, onNext, t, darkMode = false, canProceed = true, visible = true }) => {
    ...
    const navSurface = darkMode ? 'bg-gray-900/95 border-gray-600' : 'bg-white/95 border-text-main'
          ...
          {isPreviewStep && (
            ...
            >
              ...
              <span className="hidden sm:inline">
                {nav?.finish ?? ui?.finish ?? labels?.done ?? 'Finish'}
              </span>
            </button>
          )}
