...
const SwissDocument = ({ data, t, templateType = 'classic' }) => {
  ...
  const getTemplateConfig = () => {
    const configs = {
      classic: {
        container: 'w-[210mm] h-[297mm] bg-white text-slate-900 p-[15mm] text-sm font-sans relative box-border flex flex-col shadow-none mx-auto overflow-hidden',
        headerContainer: 'mb-4',
        headerFlex: 'flex items-center justify-between mb-3',
        headerIconContainer: 'flex items-center gap-2',
        headerIconBg: 'bg-slate-900 text-white p-1.5 rounded',
        headerIconSize: 16,
        titleText: 'text-xl font-black uppercase tracking-wide',
        subtitleText: 'text-[10px] uppercase tracking-widest text-slate-500 mt-0.5',
        ...
        mainWidth: 'flex-1',
        mainSpace: 'space-y-3',
        footerContainer: 'mt-auto pt-3 border-t-2 border-slate-900 flex justify-between items-end',
        footerText: 'text-[9px] text-slate-400 uppercase tracking-wider',
        footerSignContainer: 'w-48 border-t-2 border-slate-900 pt-1',
        footerSignText: 'text-[9px] uppercase font-black tracking-wider',
        badge: null // No badge for classic
      },

      modern: {
        container: 'w-[210mm] h-[297mm] bg-gradient-to-br from-white via-rose-50 to-pink-50 text-slate-900 p-[14mm] text-sm leading-relaxed font-sans relative box-border flex flex-col shadow-none mx-auto overflow-hidden',
        headerContainer: 'mb-4',
        headerFlex: 'bg-gradient-to-r from-rose-400 to-pink-400 -mx-[14mm] -mt-[14mm] px-[14mm] pt-[14mm] pb-4 mb-4 text-white flex items-center justify-between',
        headerIconContainer: 'flex items-center gap-3',
        headerIconBg: 'bg-white text-rose-500 p-2 rounded-full shadow-lg',
        headerIconSize: 20,
        titleText: 'text-2xl font-black',
        subtitleText: 'text-xs font-medium opacity-90 mt-0.5',
        dateText: 'text-xs text-right opacity-90',
        dateLabel: today,
      ...
      compact: {
        container: 'w-[210mm] h-[297mm] bg-white text-slate-900 p-[12mm] text-xs font-sans relative box-border flex flex-col shadow-none mx-auto overflow-hidden',
        headerContainer: 'mb-3',
        headerFlex: 'flex items-center justify-between mb-2 border-b border-slate-300 pb-2',
        headerIconContainer: 'flex items-center gap-2',
        headerIconBg: 'bg-slate-900 text-white p-1.5',
        headerIconSize: 14,
        titleText: 'text-base font-bold',
        subtitleText: 'text-[9px] text-slate-500 uppercase tracking-wider',
        dateText: 'text-[9px] text-slate-400',
        dateLabel: today,
        mainLayout: 'flex gap-4 flex-1',
        sidebarWidth: 'w-[35%]',
        sidebarSpace: 'space-y-2',
        mainWidth: 'flex-1',
        mainSpace: 'space-y-2',
        footerContainer: 'mt-auto pt-2 border-t border-slate-300 text-center',
        footerText: 'text-[8px] text-slate-400',
        footerSignContainer: null,
        footerSignText: null,
        badge: null
      }
