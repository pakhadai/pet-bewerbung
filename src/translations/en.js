...
export default {
  ...
  legal: {
    ...
    securityLogs: "Security & Rate Limiting",
    securityLogsText: "To prevent abuse (rate limiting), your IP address is temporarily stored on our server for a maximum of 24 hours. This data is automatically deleted and not linked to your pet dossier. Under Swiss nFADP, IP addresses are considered personal data.",
