...
export default {
  ...
  legal: {
    ...
    securityLogs: "Sécurité et limitation du débit",
    securityLogsText: "Pour prévenir les abus (limitation du débit), votre adresse IP est temporairement stockée sur notre serveur pendant 24 heures maximum. Ces données sont automatiquement supprimées et ne sont pas liées à votre dossier pet.",
