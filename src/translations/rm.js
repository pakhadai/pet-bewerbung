...
export default {
  ...
  legal: {
    ...
    securityLogs: "Segirezza e rate limiting",
    securityLogsText: "Per impedir abus (rate limiting) vegn vossa adressa IP temporarmain memorisada sin noss server per maximal 24 uras. Questas datas vegnan stizzadas automaticamain e n'èn betg colliadas cun voss dossier pet.",
