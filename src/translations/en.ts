...
export default {
  ...
  landing: {
    ...
    heroSub:
      'An entertaining service to surprise your landlord and stand out from the competition. Create a professional dossier for your pet with all important information – it might increase your chances of getting a rental with your furry friend.',
    ...
    features: [
      { title: 'Stand Out', desc: 'Surprise landlords with a unique, professional Pet CV.' },
      {
        ...
        desc: 'Present all important details about your pet at a glance.',
      },
      {
        title: 'Fun & Professional',
        desc: 'An entertaining service that still looks serious and may improve your chances.',
      },
  ...
  ui: {
    ...
    insuranceInfoDog:
      'For dogs, AMICUS and liability insurance are often mandatory in Switzerland.',
  ...
  step4: {
    ...
    heicFallback:
      'HEIC/HEIF can be unstable in some browsers. If upload fails, please convert to JPG and try again.',
  ...
  labels: {
    ...
    descriptionPlaceholder:
      'Buddy is a high-energy Golden Retriever who loves belly rubs and chasing squirrels...',
  ...
  templates: {
    ...
    outro:
      'The animal is accustomed to apartment living and causes no noise disturbance. Comprehensive liability coverage is in place for any potential damages.',
  },
  generationText: {
    openings: [
    ...
    social: {
      ...
      petsGood:
        '{name} approaches other animals with friendly curiosity and strong social compatibility, ensuring a harmonious coexistence in any household.',
      petsNeutral:
  ...
  legal: {
    ...
    dataCollectionText:
      'All data you enter (name, address, pet information, photos) is processed exclusively in your browser. No personal data is transmitted to or stored on our servers. PDF and text generation happens entirely offline on your device.',
    textGeneration: 'Automatic text generation',
    textGenerationText:
      'Automatic text generation is done entirely locally in your browser. No data is sent to any server or third party.',
    thirdParty: 'Third-Party Services',
    fontsText: 'We use locally hosted fonts to avoid data transfer to Google servers.',
    cookies: 'Cookies',
    cookiesText:
      'We use only technically necessary cookies to store your language and theme preferences. No tracking cookies are used.',
    rights: 'Your Rights',
    rightsText:
  ...
  hero: {
    ...
    problemDesc:
      'In Switzerland the rental market is highly competitive. Many landlords are skeptical about pets.',
    solutionTitle: 'Your solution: The Pet Dossier',
    solutionDesc:
      'A professional CV shows responsibility, proves insurance coverage and sets you apart from other applicants.',
    cta: 'Create Now',
  ...
  step2Emergency: {
    privacyText:
      'Private & Secure: Your emergency contacts are only stored locally in this browser session.',
    ...
    items: [
      {
        id: 'q1',
        category: 'general',
        q: 'Does this Pet Dossier guarantee I get the apartment?',
        a: 'No, there is no guarantee. But a professional dossier shows the landlord that you take responsibility (insurance, training). In Switzerland, landlords often choose the candidate who poses the least risk – this document minimizes concerns.',
      },
      {
        id: 'q2',
        category: 'privacy',
        q: 'Where are my data stored, and do they leave my device?',
        a: "Nowhere on our servers. 'Local-First' means all your data (names, photos, addresses) is processed only in your browser. Once you download the PDF and close the tab, the data is gone.",
      },
      {
        id: 'q3',
        category: 'cost',
        q: 'How much does the service cost?',
        a: 'The service is completely free. You get 5 templates (Classic, Modern, Compact, Buddy, Buddy test) and can download them as PDF (and ZIP on desktop).',
      },
      {
        id: 'q4',
        category: 'cost',
        q: "What's included?",
        a: 'All 5 template designs, automatic text generation based on your input, PDF download, and ZIP download on desktop.',
      },
      {
        id: 'q5',
        category: 'privacy',
        q: 'How is the pet description generated? Does ChatGPT read my data?',
        a: 'The description is created automatically in your browser using template-based logic. We intentionally do not use external text-generation services, so your data is never sent to third parties.',
      },
      {
        id: 'q6',
        category: 'tips',
        q: "Why can't I download a ZIP on my phone?",
        a: 'Generating multiple PDFs at once requires a lot of memory. To keep the app stable and prevent browser crashes (OOM), ZIP downloads are disabled on mobile devices.',
      },
      {
        id: 'q7',
        category: 'privacy',
        q: 'Is uploading my pet photo safe?',
        a: 'Yes. Your photo is processed and compressed locally on your device before being embedded into the PDF. It is not uploaded to any server.',
      },
      {
        id: 'q8',
        category: 'tips',
        q: 'Which insurances are important in Switzerland?',
        a: 'For dog owners, private liability insurance (Privathaftpflicht) with coverage for tenant damage is essential. Proof of AMICUS registration is often also required. Our dossier highlights these points.',
      },
      {
        id: 'q9',
        category: 'general',
        q: 'Can I edit the dossier later?',
        a: "As long as you don't close the browser or reload the page, your data remains. After closing, you must create a new dossier.",
      },
      {
        id: 'q10',
        category: 'general',
        q: 'Do I need to sign the Pet CV?',
        a: 'A signature is not legally required by the service. However, we recommend printing and signing the PDF yourself (or adding a scanned/ digital signature) to increase trust with your landlord.',
      },
    ],
