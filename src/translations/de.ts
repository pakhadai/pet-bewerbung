...
export default {
  ...
  landing: {
    ...
    heroSub:
      'Ein unterhaltsamer Service, um Ihren Vermieter zu überraschen und sich von der Masse abzuheben. Erstellen Sie ein professionelles Dossier für Ihren Vierbeiner mit allen wichtigen Informationen – vielleicht erhöht es Ihre Chancen auf eine Wohnung mit Haustier.',
    cta: 'Jetzt Pet CV erstellen',
    trust: '100% Kostenlos • Keine Anmeldung',
    features: [
      {
        title: 'Vom Rest abheben',
        desc: 'Überraschen Sie Vermieter mit einem einzigartigen, professionellen Pet CV.',
      },
      {
        title: 'Vollständige Informationen',
        desc: 'Präsentieren Sie alle wichtigen Details über Ihren Vierbeiner auf einen Blick.',
      },
      {
        title: 'Unterhaltsam & Professionell',
        desc: 'Ein spaßiger Service, der trotzdem seriös wirkt und Ihre Chancen verbessern kann.',
      },
      ...
      { title: 'Keine Registrierung', desc: 'Kein Konto nötig — schnell und anonym.' },
      {
        ...
        desc: 'Daten werden nach dem Erstellen nicht aufbewahrt — maximaler Datenschutz.',
      },
    ],
  },
  steps: [
  ...
  preview: {
    ...
    instruction:
      'Verwenden Sie die Schaltflächen unten zum Herunterladen oder Versenden des Dokuments',
  },
  ...
  step4: {
    ...
    heicFallback:
      'HEIC/HEIF wird in manchen Browsern instabil unterstützt. Falls der Upload fehlschlägt, bitte als JPG speichern und erneut hochladen.',
  ...
  labels: {
    ...
    descriptionPlaceholder:
      'Buddy ist ein temperamentvoller Golden Retriever, der Bauchkraulen und Eichhörnchen liebt...',
    ...
    storageQuotaError:
      'Privatmodus erkannt: Daten werden nicht gespeichert. Seite nicht aktualisieren!',
  ...
  thankYou: {
    ...
    privacyLocal:
      'Ihre Daten wurden lokal verarbeitet und niemals auf unseren Servern gespeichert.',
    createAnother: '← Noch eines erstellen',
    purrPerfect: 'PURR-FECT!',
  },
  templates: {
    intro:
      'Bei dem beschriebenen Tier handelt es sich um einen sehr gepflegten und sozialverträglichen Mitbewohner.',
    keywords: 'Besonders hervorzuheben sind folgende Eigenschaften: ',
    outro:
      'Das Tier ist an das Leben in einer Wohnung gewöhnt und verursacht keine Lärmbelästigung. Für allfällige Schäden besteht eine umfassende Haftpflichtdeckung.',
  },
  generationText: {
    openings: [
    ...
    noise: {
      ...
      medium:
        '{name} zeigt ein ausgewogenes Temperament und äussert sich nur in verständlichen Situationen, etwa bei Besuch oder ungewohnten Geräuschen – im Alltag bleibt die Lautstärke stets angenehm.',
    ...
    social: {
      childrenGood:
        'Im Umgang mit Kindern beweist {name} viel Geduld und Einfühlungsvermögen – eine natürliche Sanftmut, die Familien besonders zu schätzen wissen.',
      childrenNeutral:
        'Gegenüber Kindern verhält sich {name} respektvoll und zurückhaltend, ohne aufdringlich zu werden.',
      petsGood:
        'Anderen Tieren begegnet {name} mit freundlicher Neugier und ausgeprägter sozialer Verträglichkeit, was ein harmonisches Miteinander gewährleistet.',
      petsNeutral:
        'Im Kontakt mit anderen Tieren zeigt {name} eine gelassene Eigenständigkeit – weder ängstlich noch dominant, sondern ruhig und selbstsicher.',
    },
    routines: [
    ...
    responsibility:
      'Regelmässige tierärztliche Kontrollen, ein vollständiger Impfschutz und eine konsequente Pflege zeugen von Verantwortungsbewusstsein und sorgen dafür, dass gesundheitliche Risiken minimiert werden.',
    closings: [
  ...
  legal: {
    ...
    disclaimerText:
      'Dieser Service erstellt Bewerbungsunterlagen für Haustiere. Die Nutzung dieses Services garantiert keine Akzeptanz durch Vermieter oder Hausverwaltungen. Die erstellten Dokumente dienen Informationszwecken und als Ergänzung zu Ihrer Mietbewerbung.',
    liability: 'Haftungsbeschränkung',
    liabilityText:
      'Wir übernehmen keine Gewähr für die Richtigkeit, Vollständigkeit oder Aktualität der bereitgestellten Informationen. Die Nutzung dieses Services erfolgt auf eigene Gefahr. Wir haften nicht für Schäden, die durch die Nutzung oder Unfähigkeit zur Nutzung dieses Services entstehen.',
    copyright: 'Urheberrecht',
    copyrightText:
      'Alle Inhalte dieser Website sind urheberrechtlich geschützt. Vervielfältigung oder Nutzung ohne ausdrückliche Genehmigung ist untersagt. Nutzer sind dafür verantwortlich, dass sie die Rechte an hochgeladenen Fotos besitzen.',
    privacyIntro: 'Datenschutz',
    privacyIntroText:
      'Wir nehmen den Schutz Ihrer persönlichen Daten ernst. Diese Datenschutzerklärung erklärt, wie wir mit Ihren Informationen umgehen.',
    dataCollection: 'Datenerhebung',
    dataCollectionText:
      'Alle von Ihnen eingegebenen Daten (Name, Adresse, Tierinformationen, Fotos) werden ausschliesslich in Ihrem Browser verarbeitet. Es werden keine personenbezogenen Daten auf unsere Server übertragen oder gespeichert. Die PDF- und Text-Erstellung erfolgt vollständig offline auf Ihrem Gerät.',
    textGeneration: 'Automatische Texterstellung',
    textGenerationText:
      'Die automatische Texterstellung erfolgt vollständig lokal in Ihrem Browser. Keine Daten werden an Server oder Dritte übertragen.',
    thirdParty: 'Drittanbieter-Dienste',
    fontsText:
      'Wir verwenden lokal gehostete Schriftarten, um Datenübertragungen an Google-Server zu vermeiden.',
    cookies: 'Cookies',
    cookiesText:
      'Wir verwenden nur technisch notwendige Cookies, um Ihre Sprach- und Design-Einstellungen zu speichern. Es werden keine Tracking-Cookies verwendet.',
    rights: 'Ihre Rechte',
    rightsText:
      'Nach Schweizer Datenschutzrecht (DSG/nDSG) und DSGVO haben Sie das Recht auf Auskunft, Berichtigung, Löschung und Datenübertragbarkeit. Da wir Ihre Daten nicht speichern, sind diese Rechte automatisch erfüllt.',
    contact: 'Kontakt',
    contactText: 'Für Datenschutzanfragen: info@pet-bewerbung.ch',
    scope: 'Geltungsbereich',
    scopeText:
      'Diese Bedingungen gelten für die Nutzung von Pet-Bewerbung.ch. Mit der Nutzung dieses Services stimmen Sie diesen Bedingungen zu.',
    services: 'Leistungen',
    servicesText:
      'Wir bieten ein kostenloses Tool zur Erstellung von Haustier-Bewerbungsunterlagen (Pet CV) für Mietbewerbungen in der Schweiz. Der Service umfasst Formularausfüllung, automatische Textgenerierung und PDF-Erstellung.',
    ...
    changesText:
      'Wir behalten uns das Recht vor, diese Bedingungen jederzeit zu ändern. Die fortgesetzte Nutzung des Services bedeutet Akzeptanz der aktualisierten Bedingungen.',
  ...
  hero: {
    ...
    solutionDesc:
      'Ein professioneller Lebenslauf zeigt Verantwortung, belegt Versicherungsschutz und hebt Sie von anderen Bewerbern ab.',
    cta: 'Jetzt erstellen',
  ...
  step2Emergency: {
    privacyText:
      'Privat & sicher: Ihre Notfallkontakte werden nur lokal in dieser Browsersitzung gespeichert.',
    ...
    items: [
      {
        id: 'q1',
        category: 'general',
        q: 'Garantiert dieses Pet-Dossier eine Wohnungszusage?',
        a: 'Nein, eine Garantie gibt es nicht. Aber ein professionelles Dossier zeigt dem Vermieter, dass Sie Verantwortung übernehmen (Versicherung, Erziehung). In der Schweiz entscheiden sich Vermieter oft für den Kandidaten, der das geringste Risiko darstellt – dieses Dokument minimiert Bedenken.',
      },
      {
        id: 'q2',
        category: 'privacy',
        q: 'Wo werden meine Daten gespeichert, und verlassen sie mein Gerät?',
        a: "Nirgendwo auf unseren Servern. 'Local-First' bedeutet: Alle Ihre Daten (Namen, Fotos, Adressen) werden nur in Ihrem Browser verarbeitet. Sobald Sie das PDF herunterladen und den Tab schliessen, sind die Daten weg.",
      },
      {
        id: 'q3',
        category: 'cost',
        q: 'Was kostet der Service?',
        a: 'Der Service ist vollständig kostenlos. Sie erhalten 5 Vorlagen (Classic, Modern, Compact, Buddy, Buddy Test) und können diese als PDF herunterladen (ZIP ist auf dem Desktop verfügbar).',
      },
      {
        id: 'q4',
        category: 'cost',
        q: 'Was ist enthalten?',
        a: 'Alle 5 Vorlagendesigns, automatische Texterstellung basierend auf Ihren Angaben, PDF-Download sowie ZIP-Download auf dem Desktop.',
      },
      {
        id: 'q5',
        category: 'privacy',
        q: 'Wie wird die Beschreibung erstellt? Liest ChatGPT meine Daten?',
        a: 'Die Beschreibung wird automatisch in Ihrem Browser erstellt – basierend auf Vorlage-Logik. Wir verwenden bewusst keine externen Texterstellungsdienste, damit Ihre Daten nie an Dritte gesendet werden.',
      },
      {
        id: 'q6',
        category: 'tips',
        q: 'Warum kann ich auf dem Handy kein ZIP herunterladen?',
        a: 'Das gleichzeitige Erstellen mehrerer PDFs benötigt viel Speicher. Damit die App stabil bleibt und Browser-Crashes (OOM) verhindert werden, sind ZIP-Downloads auf Mobilgeräten deaktiviert.',
      },
      {
        id: 'q7',
        category: 'privacy',
        q: 'Ist das Hochladen meines Fotos sicher?',
        a: 'Ja. Ihr Foto wird auf Ihrem Gerät verarbeitet und komprimiert, bevor es in das PDF eingebettet wird. Es wird nicht auf einen Server hochgeladen.',
      },
      {
        id: 'q8',
        category: 'tips',
        q: 'Welche Versicherungen sind in der Schweiz wichtig?',
        a: 'Für Hundehalter ist eine Privathaftpflichtversicherung (Privathaftpflicht) mit Deckung für Mieterschäden essenziell. Oft wird auch der Nachweis der AMICUS-Registrierung verlangt. Unser Dossier hebt diese Punkte hervor.',
      },
      {
        id: 'q9',
        category: 'general',
        q: 'Kann ich das Dossier später bearbeiten?',
        a: 'Solange Sie den Browser nicht schliessen oder die Seite neu laden, bleiben Ihre Daten erhalten. Nach dem Schliessen müssen Sie ein neues Dossier erstellen.',
      },
      {
        id: 'q10',
        category: 'general',
        q: 'Muss ich das Pet-Dossier unterschreiben?',
        a: 'Eine Unterschrift ist für den Service rechtlich nicht erforderlich. Wir empfehlen jedoch, das PDF auszudrucken und selbst zu unterschreiben (oder eine gescannte/digitale Signatur hinzuzufügen), um dem Vermieter mehr Vertrauen zu geben.',
      },
    ],
