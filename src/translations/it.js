...
export default {
  ...
  legal: {
    ...
    stripeText: "Per l'elaborazione dei contributi di sostegno utilizziamo Stripe. I vostri dati di pagamento vengono elaborati direttamente da Stripe secondo la loro privacy policy.",
