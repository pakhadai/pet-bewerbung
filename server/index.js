...
app.post('/create-payment-intent', async (req, res) => {
  ...
  try {
    // Use explicit payment_method_types to avoid Link (Stripe's save-card feature)
    // Link requires automatic_payment_methods, so we explicitly list methods instead
